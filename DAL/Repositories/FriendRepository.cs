...
namespace SocialNetwork.DAL.Repositories
{
    public class FriendRepository : BaseRepository, IFriendRepository
    {
        ...
        public int Delete(int user_id, int friend_id)
        {
            return Execute(@"delete from friends where user_id = :user_id and friend_id = :friend_id", new {user_id = user_id, friend_id = friend_id });
        }
    ...
    public interface IFriendRepository
    {
        ...
        int Delete(int user_id, int friend_id);
    }
}
